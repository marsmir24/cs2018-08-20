...
strictfp class TaskB1 {
    public static  void main(String[] args) {
        double d=111.111D; //присваивание в десятичном формате,
        byte b = 0b111; //присваивание в двоичном формате
        long o =0111L; // присваивание в восьмеричном формате
        int h =0x111; //присваивание в шестнадцатиричном формате
